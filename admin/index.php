	 ...
	 <div class="container">
	 	...
	 	<section id="menu">
			...
			<article>
				...
				<a href="tambah.php" class="btn btn-success mt-3 mb-3">Tambah data</a>
				<table class="table">
					...
					<tr>
						...
						<td><?= $d['alamat']?></td>
						<td>
							<a class="badge badge-warning" href="../admin/edit.php?id=<?= $d['id_mhs']?>" onclick="return confirm('Apakah anda ingin mengedit data?')" >Edit</a>
							<a class="badge badge-danger" href="../config/act_hapus.php?id=<?= $d['id_mhs']?>" onclick="return confirm('Apakah anda ingin Hapus data?')">Hapus</a>
						</td>
					</tr>
				<?php endforeach?>
				</table>
